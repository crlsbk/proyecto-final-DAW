...
$query = "SELECT * FROM articulos WHERE tipo = 1 ORDER BY publicacion_fecha DESC";
                ...
                <div class="col-12">  
                    <div class="card bg-light shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="text-muted">Por: <?= htmlspecialchars($post['autor']) ?></p>
                            <p class="text-muted">Publicado el: <?= htmlspecialchars($post['publicacion_fecha']) ?></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
